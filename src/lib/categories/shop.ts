...
export const KNOWN_GEM_SUBCATEGORIES: Record<string, KnownGemSubcategoryMeta> = {
  ruby: {
    ...
    seoTitle: 'Buy Natural Ruby Gemstone | Manik',
  ...
  pearl: {
    ...
    seoTitle: 'Buy Natural Pearl Gemstone | Moti',
  ...
  'red-coral': {
    ...
    seoTitle: 'Buy Natural Red Coral Stone | Moonga',
  ...
  emerald: {
    ...
    seoTitle: 'Buy Natural Emerald Stone | Panna',
  ...
  'yellow-sapphire': {
    ...
    seoTitle: 'Buy Natural Yellow Sapphire | Pukhraj',
  ...
  diamond: {
    ...
    seoTitle: 'Buy Natural Diamond Gemstone | Heera',
  ...
  'blue-sapphire': {
    ...
    seoTitle: 'Buy Neelam Stone | Natural Blue Sapphire Price',
  ...
  hessonite: {
    ...
    seoTitle: 'Buy Natural Hessonite Stone | Gomed',
  ...
  'cats-eye': {
    ...
    seoTitle: 'Buy Catseye Gemstone | Lehsunia',
  ...
  'white-sapphire': {
    ...
    seoTitle: 'Buy Natural White Sapphire | Venus',
  ...
  pitambari: {
    ...
    seoTitle: 'Buy Pitambari Sapphire | Neelam',
  ...
  amethyst: {
    ...
    seoTitle: 'Buy Natural Amethyst Gemstone | Katela',
  ...
  'lapis-lazuli': {
    ...
    seoTitle: 'Buy Natural Lapis Lazuli Gemstone | Lajward',
  ...
  moonstone: {
    ...
    seoTitle: 'Buy Natural Moonstone Gemstone | Chandrakant',
  ...
  peridot: {
    ...
    seoTitle: 'Buy Natural Peridot Gemstone | Zabarjad',
  ...
  'rose-quartz': {
    ...
    seoTitle: 'Buy Natural Rose Quartz Gemstone | Gulabi Spatik',
  ...
  citrine: {
    ...
    seoTitle: 'Buy Natural Citrine Gemstone | Sunela',
  ...
  garnet: {
    ...
    seoTitle: 'Buy Natural Garnet Gemstone | Tamada',
  ...
  turquoise: {
    ...
    seoTitle: 'Buy Natural Turquoise Gemstone | Firoza',
  ...
  aquamarine: {
    ...
    seoTitle: 'Buy Natural Aquamarine Gemstone | Beruj',
  ...
  'tiger-eye': {
    ...
    seoTitle: 'Buy Natural Tiger Eye Gemstone | Vaidurya',
  ...
  malachite: {
    ...
    seoTitle: 'Buy Natural Malachite Gemstone',
  ...
  opal: {
    ...
    seoTitle: 'Buy Natural Opal Gemstone | Venus',
  ...
  tanzanite: {
    ...
    seoTitle: 'Buy Natural Tanzanite Gemstone',
  ...
  'blue-topaz': {
    ...
    seoTitle: 'Buy Natural Blue Topaz Gemstone | Neela Topaz',
  ...
  'white-topaz': {
    ...
    seoTitle: 'Buy Natural White Topaz Gemstone | Safed Topaz',
  ...
  zircon: {
    ...
    seoTitle: 'Buy Natural Zircon Gemstone | Jarkan',
  ...
  iolite: {
    ...
    seoTitle: 'Buy Natural Iolite Gemstone | Neeli',
  ...
  tourmaline: {
    ...
    seoTitle: 'Buy Natural Tourmaline Gemstone | Turmali',
  ...
  diopside: {
    ...
    seoTitle: 'Buy Natural Diopside Gemstone',
  ...
  kyanite: {
    ...
    seoTitle: 'Buy Natural Kyanite Gemstone | Upratna',
  ...
  sunstone: {
    ...
    seoTitle: 'Buy Natural Sunstone Gemstone',
  ...
  hakik: {
    ...
    seoTitle: 'Buy Natural Hakik Gemstone | Akik',
  ...
  'white-coral': {
    ...
    seoTitle: 'Buy Natural White Coral Gemstone | Safed Moonga',
  ...
  spinel: {
    ...
    seoTitle: 'Buy Natural Spinel Gemstone | Balas Ruby',
  ...
  chrysoberyl: {
    ...
    seoTitle: 'Buy Natural Chrysoberyl Gemstone | Lasuniya',
