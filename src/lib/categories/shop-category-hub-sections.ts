...
function gemSections(): CategoryHubSectionDef[] {
  return [
    { key: 'about', field: 'about_html', title: (label) => `About ${label}` },
    { key: 'how-to-wear', field: 'how_to_wear_html', title: (label) => `How To Wear ${label}` },
    { key: 'who-should-wear', field: 'who_should_wear_html', title: (label) => `Who Should Wear ${label}` },
    { key: 'benefits', field: 'benefits_html', title: (label) => `${label} Benefits` },
    { key: 'types', field: 'types_html', title: (label) => `${label} Types` },
    { key: 'quality-price', field: 'quality_price_html', title: (label) => `${label} Quality & Price` },
    { key: 'jewellery', field: 'jewellery_html', title: (label) => `${label} Jewellery` },
    { key: 'cleaning-care', field: 'cleaning_care_html', title: (label) => `${label} Cleaning & Care` },
