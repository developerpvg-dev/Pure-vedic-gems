...
const FORCE = new Map<string, string>([
  ...
  ['/shop/cornflower-blue-sapphire', '/gemstones/navaratna/blue-sapphire'],
  ['/shop/blue-sapphire-price', '/gemstones/navaratna/blue-sapphire'],
  ['/shop/blue-sapphire-birthstone', '/gemstones/navaratna/blue-sapphire'],
