# Navratna Phase 1 — Dry-Run Report `phase1-final`

- Generated: 2026-05-29T01:00:27.705Z
...
- Products with at least one OK image: **1734 / 1734**
...
- Rows to **insert** (legacy_woo_id new): **0**
- Rows to **update** (legacy_woo_id exists): 1734
- Rows in production not in staging (orphaned/removed): 0
